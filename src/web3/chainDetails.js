const chainDetails = {
  ...
  4: {
    ...
    network: "testnet",
    rpc: [
      "https://speedy-nodes-nyc.moralis.io/5f902eb34c405c4011e0582b/eth/rinkeby",
  ...
  81: {
    ...
    nativeCurrency: { name: "Villinius", symbol: "VIL", decimals: 18 },
    infoURL: "https://www.zenithchain.co/",
    chainId: 81,
    networkId: 81,
    shortName: "VIL",
  ...
  97: {
    ...
    chain: "BSC",
    rpc: [
      "https://speedy-nodes-nyc.moralis.io/5f902eb34c405c4011e0582b/bsc/testnet",
  ...
  534: {
    ...
    slip44: 674,
    explorers: [
      { name: "candlescan", url: "https://cndlchain.com", standard: "none" },
    ],
  },
  555: {
  ...
  8898: {
    ...
    networkId: 8898,
    explorers: [
      { name: "mmtscan", url: "https://mmtscan.io", standard: "EIP3091" },
    ],
  },
  8995: {
    name: "bloxberg",
  ...
  421611: {
    ...
    rpc: [
      "https://speedy-nodes-nyc.moralis.io/12e1414e704558bcd439c202/eth/rinkeby",
